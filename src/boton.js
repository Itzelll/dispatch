...
const MyButton = () => {
    ...
    const callWorkFlow = async (url, urlbin, modelname) => {
        ...
        await fetch('https://api.github.com/repos/itzelll/myMLOps_hello-world /dispatches', {
            method: 'POST',
            body: JSON.stringify({
            ...
            .then((data) => {
                console.log("data 2");
                console.log(data);
                URL_ENDPOINT = "https://linear-model-service-nuevo-itzelll.cloud.okteto.net/v1/models/linear-model:predict";
